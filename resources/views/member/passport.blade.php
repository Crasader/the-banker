...
@section('title'){{trans('member.purchase_passport')}} @Stop
...
<!-- Page Content -->
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2 class="panel-title">{{trans('member.purchase_passport')}}</h2>
                            <p class="panel-subtitle">{{trans('passport.commit_transaction')}}</p>
                        </div>
                        <div class="panel-body">
                            <div class="col-md-12 form-horizontal form-bordered">

                                <div class="form-group">
                                    <label class="col-md-3 control-label"><strong>{{trans('passport.balance_passport')}}</strong></label>
                                    <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><strong>{{trans('passport.passport_price')}}</strong></label>
                                    <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="inputDefault"><strong>{{trans('passport.qty_to_purchase')}}</strong></label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><strong>{{trans('passport.total_passport_price')}}</strong></label>
                                    <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><strong>{{trans('passport.discount')}}</strong></label>
                                    <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><strong>{{trans('passport.total_discount')}}</strong></label>
                                    <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><strong>{{trans('passport.total_after_discount')}}</strong></label>
                                    <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <a class="simple-ajax-modal btn btn-primary btn-block" href="{{URL::route('ajax-passport')}}" id="quantity_href" disabled>{{trans('member.purchase_passport')}}</a>
                                    </div>
                                </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table id="datatable-default" class="table table-bordered table-striped mb-none dataTable no-footer">
                                <thead>
                                <tr>
                                    <td>{{trans('passport.time_date')}}</td>
                                    <td>{{trans('passport.decription')}}</td>
                                    <td>{{trans('passport.debit')}}</td>
                                    <td>{{trans('passport.credit')}}</td>
                                </tr>
                                </thead>
                                <tbody>
                ...
                <div class="col-md-4">
                    <div class="well">
                        <p><span class="fa fa-info-circle"></span> <strong>{{trans('passport.information')}}</strong></p>
                        <p>{{trans('passport.passport_usage')}}</p>
                        <ul>
                            <li>{{trans('passport.upgrade_status')}}</li>
                            <li>{{trans('passport.use_to_ph')}}</li>
                        </ul>
                        <br>
                        <p>{{trans('passport.behalf_network_members')}}</p>
                        <p><strong>{{trans('passport.bulk_purchase')}}</strong></p>
                        <ul>
                            <li> >10 = 5%</li>
                            <li> >25 = 10%</li>
                            <li> >50 = 15%</li>
                ...
                @if ($waiting_confirmations)
                    <div class="col-md-4">
                        <div class="panel-body bg-secondary">
                            <p><span class="fa fa-info-circle"></span> <strong>{{trans('passport.payment_waiting_confirmation')}}</strong></p>
                            <table id="datatable-default" class="table table-bordered table-striped mb-none dataTable no-footer">
                                <thead>
                                <tr>
                                    <td>{{trans('passport.time_date')}}</td>
                                    <td>{{trans('passport.quantity')}}</td>
                                    <td>{{trans('passport.confirmation')}}</td>
                                </tr>
                                </thead>
                                <tbody>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-8 form-horizontal form-bordered">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label class="control-label -align-left"><strong>{{trans('passport.wallet_address')}}</strong></label>
                                    </div>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label" for="inputDefault"><strong>{{trans('passport.amount')}}</strong></label>
                                    <div class="col-md-8">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-default modal-dismiss">{{trans('passport.cancel')}}</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
